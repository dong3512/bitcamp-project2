...
public class BoardDetailHandler extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.printf("<tr><th>작성자</th> <td>%s<tr>\n", b.getWriter().getName());
      out.printf("<tr><th>등록일</th> <td>%s<tr>\n", formatter.format(b.getRegisteredDate()));
      out.printf("<tr><th>조회수</th> <td>%s<tr>\n", b.getViewCount());
      out.printf("<tr><th>좋아요</th> <td>%s<tr>\n", b.getLike());
      out.println("</tbody>");

      Member loginUser = (Member) request.getSession().getAttribute("loginUser");
      if (loginUser != null && b.getWriter().getNo() == loginUser.getNo()) {
        out.println("<tfoot>");
        out.println("<tr><td colsapn='2'>");
